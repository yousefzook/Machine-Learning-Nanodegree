...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        self.epsilon = math.exp(-self.alpha * self.t) # eps = e^(-at)
    ...
    def choose_action(self, state):
        ...
        # Be sure that when choosing an action with highest Q-value that you randomly select between actions that "tie".
            ...
            count = 0 # number of actions with max values
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning = True, alpha=0.001, epsilon=0.5)
    ...
    sim.run(n_test = 60, tolerance=0.01)
    #sim.run()
